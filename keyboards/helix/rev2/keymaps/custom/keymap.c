...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LSFT, KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RBRC , \
      KC_ESC,  ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  EISU,    KANA,    RAISE,   KC_RGUI, KC_RALT, KC_RCTL, KC_BSLS,   KC_QUOT \
      ),
