...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_ESC,  LOWER, KC_LCTL, KC_LALT, GUI_T(KC_LANG2), KC_SPC,  KC_DEL,  KC_BSPC, KC_ENT,  KC_RASEKN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, KC_LCBR, KC_RCBR, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
