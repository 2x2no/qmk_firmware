...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,  KC_X,    KC_C,    KC_V,            KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,      KC_COMM, KC_DOT,  KC_SLSH, KC_LBRC , \
      KC_ESC,  LOWER, KC_LCTL, KC_LGUI, ALT_T(KC_LANG2), KC_SPC,  KC_DEL,  KC_BSPC, KC_ENT,  KC_RASEKN, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
