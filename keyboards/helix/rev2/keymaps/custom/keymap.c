...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Qwerty
                ...
                * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
                * | Shift|   Z  |   X  |   C  |   V  |   B  | Shift| Bksp |   N  |   M  |   ,  |   .  |   /  |  [   |
                * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
                * | Esc  |Adjust| Ctrl | Alt  | LGUI |Space | EISU | KANA |Raise | RGUI |  Alt | Ctrl |   \  |  ]   |
                * `-------------------------------------------------------------------------------------------------'
                */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LSFT, KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LBRC , \
      KC_ESC,  ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  EISU,    KANA,    RAISE,   KC_RGUI, KC_RALT, KC_RCTL, KC_BSLS, KC_RBRC \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_DEL,  _______, KC_UP,   _______, _______, _______, \
      _______, _______, _______, _______, _______, _______,                   KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, KC_DEL,  KC_ENT,  KC_ENT,  _______, _______, _______, _______, \
