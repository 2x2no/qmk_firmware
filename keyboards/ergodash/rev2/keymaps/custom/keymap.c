...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_ESC,  LOWER,   KC_LCTL, KC_LALT,          KC_LGUI, KC_SPC ,_______,        _______,KC_ENT , RAISE,            KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT  \
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TAB,  _______, _______, _______, _______, _______, _______,                        _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______ , \
