...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+--------------------+------+------+------+------+------+-------------|
   * | ESC  | Lower| Ctrl | ALt  |      | LGUI| Space |                    | Enter| Raise| Tab  |
   * ,---------------------------.      .-------------.                    .--------------------.
   */

  [_QWERTY] = LAYOUT( \
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LPRN,                        KC_RPRN, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
    ...
    KC_ESC,  LOWER,   KC_LCTL, KC_LALT,          KC_LGUI, KC_SPC ,_______,       _______, KC_ENT , RAISE,   KC_TAB,           _______, _______, _______  \
  ),
   ...
   * | Shift|      |      |      |      |      |      |                    |      |      |      |      |      |      |      |
   * |-------------+------+------+------+------+------+--------------------+------+------+------+------+------+-------------|
   * | ESC  | Lower| Ctrl | ALt  |      | LGUI| Space |                    | Enter| Raise|      | Home | End  |      |      |
   * ,---------------------------.      .-------------.                    .-------------.      .---------------------------.
   */
  [_RAISE] = LAYOUT(
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  \
    KC_TILD, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, KC_UP,   _______, _______, KC_F12, \
    KC_TAB,  _______, _______, _______, _______, _______, KC_LT,                          KC_GT,   _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______ , \
    KC_LSFT, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______, _______, \
    KC_ESC,  LOWER,   KC_LCTL, KC_LALT,          KC_LGUI, KC_SPC ,_______,         _______,_______ , _______,         KC_HOME, KC_END,  _______, _______   \
  ),
