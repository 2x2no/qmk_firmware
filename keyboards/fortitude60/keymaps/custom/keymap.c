 ...
 * |      |   A  |   S  |   D  |   F  |   G  |             |   H  |   J  |   K  |   L  |   ;  |  '   |
 * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  | Esc  | Bksp |   N  |   M  |   ,  |   .  |   /  |  \   |
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               | Ctrl |  Alt | LGUI |Space |Lower |Raise |Enter | RGUI |  [   |   ]  |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_ESC,   KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS , \
